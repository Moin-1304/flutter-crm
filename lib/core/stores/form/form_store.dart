...
// Lightweight email validation without external dependency
...
abstract class _FormStore with Store {
  ...
  void validateUserEmail(String value) {
    // Treat this as a generic username field; only check for non-empty
    if (value.isEmpty) {
      formErrorStore.userEmail = "Username can't be empty";
    } else {

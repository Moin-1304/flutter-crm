...
/// Correct usage example showing how to properly initialize DioClient
class CorrectUsageExample extends StatefulWidget {
  const CorrectUsageExample({Key? key}) : super(key: key);
...
class _CorrectUsageExampleState extends State<CorrectUsageExample> {
  ...
  void _initializeStore() {
    // ✅ CORRECT WAY: Use DioConfigs with core DioClient
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Correct DioClient Usage'),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'This example shows the correct way to initialize DioClient using DioConfigs from the core package.',
                    ),
                  ],
                ),
              ),
